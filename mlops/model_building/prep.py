...
#DATASET_PATH = "hf://datasets/<-----Hugging Face User ID ----->/bank-customer-churn/bank_customer_churn.csv"
DATASET_PATH = "hf://datasets/ravithumma/bank-customer-churn/bank_customer_churn.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="ravithumma/bank-customer-churn",
        repo_type="dataset",
    )
